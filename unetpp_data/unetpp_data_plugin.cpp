...
bool evaluate_whole_swc(V3DPluginCallback2 &callback, QWidget *parent, const V3DPluginArgList & input,V3DPluginArgList & output, input_PARA &PA)
{
   ...
   for(int i = 0;i < GS_swcs.size();i++)
   {
       ...
       double n = 1;
       double manual_size = n*GS_nt_resample.listNeuron.size();
       double auto_size = n*Auto_nt_resample.listNeuron.size();
       double unetpp_size = n*Auto_Unet_nt_resample.listNeuron.size();
